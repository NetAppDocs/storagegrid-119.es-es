...
summary: Puede encontrar información detallada en cada mensaje de auditoría.  Todos los mensajes de auditoría utilizan el mismo formato. 
---
...
144102530435]]
----
El valor del atributo ATYP es SPUT. link:sput-s3-put.html["ESPOLVO"] representa una transacción S3 PUT, que registra la ingesta de un objeto en un depósito.
