...
summary: Puede utilizar la solicitud S3 SelectObjectContent para filtrar el contenido de un objeto S3 según una declaración SQL simple. 
---
...
Para más información véase https://docs.aws.amazon.com/AmazonS3/latest/API/API_SelectObjectContent.html["Referencia de la API de Amazon Simple Storage Service: SelectObjectContent"^] .
...
----
Las primeras líneas del archivo a consultar, `SUB-EST2020_ALL.csv` , luce así:
